        ...
        <div className="fade-in">
          <div className="projects-header">
            <div>
              ...
              <p className="dash-sub">Tus portadas y teleprompters guardados</p>
            </div>
              ...
              {filtered.map(p => (
                <div key={p.id} className="project-card fade-in">
                  ...
                  <div className="project-actions">
                    ...
                    <button className="btn btn-gold btn-sm" onClick={() => navigate(`/present/${p.id}`)}>⛶ Presentar</button>
      ...
      {deleteModal && (
        <div className="modal-overlay" onClick={() => setDeleteModal(null)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <p style={{color:'#aaa',marginBottom:20}}>¿Seguro que quieres eliminar <strong style={{color:'#fff'}}>"{deleteModal.nombre}"</strong>? No se puede deshacer.</p>
